...
python make_result.py -e "p2p" -i "./img_temp" -o "./result/p2p/assets"
python  calculate_score.py -e "p2p" -i "./img_temp" -o "./result/p2p"

# zip -r to_notion_pnp.zip result/p2p/

# python make_result.py -e "pnp" -i "./img" -o "./result/masactrl/assets"
# python  calculate_score.py -e "pnp" -i "./img" -o "./result/masactrl"

# zip -r to_notion_pnp.zip result/masactrl/
