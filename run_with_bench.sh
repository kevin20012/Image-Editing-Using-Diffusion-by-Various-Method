...
conda run -n pnp --no-capture-output python -u run_with_bench.py \
                --output_path ./calc_score/img \
                --edit_category_list 0 \
                --edit_method_list ddim+pnp null-text-inversion+pnp negative-prompt-inversion+pnp directinversion+pnp \
                --rerun_exist_images

# ddim+pnp null-text-inversion+pnp negative-prompt-inversion+pnp directinversion+pnp
# ours+pnp